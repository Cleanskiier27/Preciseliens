...
setup(
    ...
    author="The Hugging Face team (past and future) with the help of all our contributors (https://github.com/NETWORKBUSTER/Preciseliens/graphs/contributors)",
    ...
    url="https://github.com/NETWORKBUSTER/Preciseliens",
    package_dir={"": "src"},
