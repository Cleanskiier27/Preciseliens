...
| [Tour rapide : Scripts d'ajustement fin/d'utilisation](https://github.com/Cleanskiier27/Preciseliens/tree/main/examples) | Scripts d'exemple pour ajuster finement les modèles sur une large gamme de tâches |
